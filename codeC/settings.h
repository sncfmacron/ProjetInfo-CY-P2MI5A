...
#define ERROR_INVALID_STATION_TYPE 3
#define ERROR_INVALID_CONSUMER_TYPE 4

#define ERROR_FILE_ALLOC 5
#define ERROR_FILE_WRITE_FAILED 6

#define ERROR_INVALID_STRING 7
#define ERROR_INVALID_STATION 8
